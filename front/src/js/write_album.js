...
//定义一个初始化ueditor
Album.prototype.initUeditorEvent = function(){
...
Album.prototype.listenUploadFilesEvent = function(){
    //获取上传的按钮
    var uploadBtn = $('#cover_img');
