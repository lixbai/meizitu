...
#美女首页
# def index(request):
#     beautys = Beauty.objects.prefetch_related('tags').all()
...
#改写美女首页,用分页
class BeautyView(View, MyPaginatorMixin):
    def get(self, request, *args, **kwargs):
        ...
        #作分页处理
        paginator = Paginator(beautys, 10)
...
class TagGetBeautyView(View, MyPaginatorMixin):
    def get(self, request, tag, *args, **kwargs):
        ...
        #处理分页
        paginator = Paginator(beautys, 12)
        page_obj = paginator.page(page)
